      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border border-acg-blue bg-transparent px-6 py-3 text-sm font-medium text-acg-blue hover:bg-slate-100"
          >
            {secondaryCtaLabel}
          </a>
        </div>
