...
const FOP_PRRO_FEATURES: ServiceItem[] = [
  ...
  {
    title:
      "Перевірка відповідності даних Z-звіту з даними електронного кабінету.",
  },
  {
    title: "Інформування про наявність помилок та розбіжностей (ПРРО).",
  },
  {
    title:
      "Формування актів виправлення помилок при проведенні розрахункових операцій.",
  },
];
